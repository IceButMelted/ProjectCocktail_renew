...
> ⚠️ **บันทึกแผน ณ 2026-08-21** — ทุกจุดที่พูดถึง `CompatibleGlass`/`GlassType.NotFix`/
> `SO_GlassVisualTable`/S13/D5/§21.0 เป็นสถานะ/แผนวันนั้น **ระบบแก้วถูกรื้อและสร้างใหม่ทั้งชุด
> วันที่ 2026-08-22** (ผู้เล่นเลือกแก้วเสิร์ฟเอง ไม่ผูกกับสูตรอีกต่อไป) ดูสถานะจริงที่
> `Docs/Bar410_GlassFreedom_ManualSetup.md` และ `GDD_Bar410_Master.md` §21 — อย่าอ้างอิงส่วนแก้ว
> ในเอกสารนี้เป็นสถานะปัจจุบัน
