...
> ⚠️ **เอกสารนี้เป็นบันทึกสถานะ ณ วันที่ 2026-08-21** ทุกจุดที่พูดถึง `CompatibleGlass`/
> `GlassType.NotFix`/`SO_GlassVisualTable`/S13 เป็นสถานะ ณ วันนั้น — **ระบบแก้วทั้งชุดถูกรื้อและ
> สร้างใหม่วันที่ 2026-08-22** (ผู้เล่นเลือกแก้วเสิร์ฟเองแทน ไม่ผูกกับสูตรอีกต่อไป) ดูสถานะปัจจุบัน
> จริงที่ `Docs/Bar410_GlassFreedom_ManualSetup.md` และ `GDD_Bar410_Master.md` §21 — **อย่าอ้างอิง
> ส่วนแก้วในเอกสารนี้เป็นสถานะปัจจุบัน**
...
**S13** — ✅ ปิดจริงแล้ว 2026-08-22 (ไม่ใช่ทางที่ระบุไว้ตอนแรกด้านบน — ดูหมายเหตุตอนต้นไฟล์)
